...
var ProjectState = /** @class */ (function (_super) {
    ...
    ProjectState.prototype.addProject = function (title, description, numOfPeople, comment) {
        var newProject = new project_model_1.Project(Math.random().toString(), title, description, numOfPeople, comment, project_model_1.ProjectStatus.Active);
